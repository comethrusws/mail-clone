<template>
    <div id="EmailView" class="bg-gray-50 h-screen overflow-auto">
        <div class="flex items-center p-2">
            <div class="logo-section flex justify-start items-center px-3.5">
                ...
                <img width="107px" src="../../../public/img/GmailLogo.png">
            </div>
        ...
        <div class="flex w-full justify-between">
            <div id="SideMenu" class="side-menu">
                <div @click="newMessageOpen = !newMessageOpen" class="flex items-center justify-center bg-sky-200 w-36 h-8 mt-2 rounded-2xl ml-2 p-7">
        ...
        <div v-if="newMessageOpen" id="NewMessageSection" class="absolute bottom-0 right-0 mr-20 rounded-t-lg shadow-2xl bg-white overflow-hidden">
            <div class="flex items-center justify-between rounded-t-lg w-full text-sm px-3.5 py-2.5 bg-gray-200">
                <div>New Message</div>
                <CloseIcon @click="newMessageOpen = false" class="cursor-pointer hover:bg-slate-400" :size="19"/>
            </div>

            <div>
                <div class="relative flex items-center px-3.5 py-2">
                    <div class="text-sm text-gray-700">To:</div>
                    <input class="w-full h-6 border-transparent border-none focus:ring-0 outline-none" type="email">
            ...
            <div class="m-3">
                <textarea style="resize: none;" class="w-full border-transparent border-none focus:ring-0 outline-none"  rows="14"></textarea>
            </div>
            <div class="p-4 mt-5">
                <button class="bg-blue-700 hover:bg-blue-600 text-white text-sm font-bold py-2 px-4 rounded-full">Send Message</button>
            </div>
        </div>
    </div>
</template>
